test_that("label works", {
  ...
  expect_equal(label_seq_from_length(from = 8, length = 3, prefix = "P", sep_prefix = "-"), c("P-08", "P-09", "P-10"))
  expect_equal(label_seq_to_length(to = 10, length = 3, suffix = "P", sep_suffix = "-"), c("08-P", "09-P", "10-P"))
