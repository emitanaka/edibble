...
* plot and print outputs for intermediate constructs of the experimental design with configurations for most graphical elements (see `vignette("output")`),
* make classical named designs (see `vignette("named-designs")`),
* add context that also serves as notes about experiment (see `vignette("edibble")`).
