...
For `simulate_rcrds()`, you also need to install the `simulate` package which is currently only 
available on GitHub:
...
* print outputs for intermediate constructs of the experimental design with configurations for most graphical elements (see [`vignette("output")`](https://edibble.emitanaka.org/articles/output.html)),
