...
When you construct an experimental design, there are many intermediate steps along the way before you are ready to serve your design. edibble stores these intermediate constructs as an *edibble graph* (`edbl_graph`) which you can visualise in a number of ways. 
